...
<script type="text/javascript">
	...
	function modifyBase(){
		...
		$.ajax({
			...
			data : 'customerid=' + customerid+'&customerKey='+customerKey+'&clientnumber='+clientnumber+'&address='+address+'&customername='+customername,
			dataType : 'json',
			type : 'post',
			error: function (e) { $.ligerDialog.error('出现未知错误'); },
			success : function(data) {
				if(data.success!=undefined){
					$.ligerDialog.success('修改客户基础信息成功！');
				}
					...
					<table cellpadding="0" cellspacing="0" class="l-table-edit">
						<tr>
							...
							<td align="left" class="l-table-edit-td"><input readonly="readonly" 
								name="customername" type="text" id="customername" ltype="text" /></td>
							<td align="left"></td>
						</tr>
						<tr>
							<td align="right" class="l-table-edit-td">客户号:</td>
							<td align="left" class="l-table-edit-td" ><input 
								name="clientnumber" type="text" id="clientnumber" ltype="text" /></td>
							<td align="left"></td>
						</tr>
						<tr>
							<td align="right" class="l-table-edit-td">客户地址:</td>
							<td align="left" class="l-table-edit-td"><input
								name="address" type="text" id="address" ltype="text" /></td>
							<td align="left"></td>
						</tr>
						<tr>
							<td align="right" class="l-table-edit-td">webService验证KEY:</td>
							<td align="left" class="l-table-edit-td" style="width: 400px"><input style="width: 400px"
								name="customerKey" type="text" id="customerKey" ltype="text" placeholder="webService验证KEY" /></td>
							<td align="left"></td>
						</tr>
					</table>
					</form>
