...
/**
 * DsfTestitems entity. @author MyEclipse Persistence Tools
 */

public class DsfTestitems implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4159728185781050233L;
	...
	public DsfTestitems(BigDecimal id, String createTime, String createUser,
			String description, Long algorithm, String english,
			String enumData, String guide, String importance, String indexId,
			Long isprint, String knowledgename, String method,
			String modifyTime, String modifyUser, String name,
			Long needhistory, String printord, String sampleFrom, String type,
			String unit, String labdepartment, String instrument,
			String defaultvalue, String principle, String workcriterion,
			String increasedhint, String decreasedhint, String notes,
			String inuredate, String outdate, String outdateoperator,
			String tea, String ccv, String testclass, BigDecimal qcneed,
			String methodname, BigDecimal testkind, String dictionaries,
			String customerid) {
		super();
		this.id = id;
